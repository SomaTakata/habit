...
import { SettingsDetailDialogContent } from "./SettingsModal";
import { Button } from "@/components/ui/button";
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar";
import { Input } from "@/components/ui/input";
import { Label } from "@/components/ui/label";

interface setSettingsOpenProps {
  setSettingsOpen: (value: boolean) => void;
}

const SettingsDetailPage = ({ setSettingsOpen }: setSettingsOpenProps) => {
  return (
    <SettingsDetailDialogContent className="w-full h-full z-50">
      <div className="h-full flex flex-col items-center justify-center gap-14 w-full">
        ...
        <div className="grid w-full max-w-sm items-center gap-1.5">
          <Label htmlFor="picture">user_id</Label>
